...
public class Gui {
    ...
    private void setupEvents() {
        ...
        runButton.addActionListener(e -> {
            ...
            new Thread(() -> {
                Main.runMain(jacocoAgentJarPathText.getText().trim(),
                        jacocoOutputPathText.getText().trim(),
                        jarToTestPathText.getText().trim(),
                        bbTestsText.getText().trim(),
                        timeGoalText.getText().trim(),
    ...
    private File getRootDirectory() {
    	String 	preferredPath = null, 
    			alternativePath = SystemUtils.USER_HOME;
    ...
    private JButton getJacocoAgentJarPathChooseButton() {
        if (jacocoAgentJarPathChooseButton == null) {
            ...
            jacocoAgentJarPathChooseButton.addActionListener(set(getJacocoAgentJarPathChooser(), jacocoAgentJarPathText));
        }
    ...
    private class WButton extends JButton {
        ...
        public Dimension getPreferredSize() {
            int textW = StringUtils.isEmpty(getText()) ? 0 : getFontMetrics(getFont()).stringWidth(getText()) + getInsets().left + getInsets().right;
        ...
        protected void paintComponent(Graphics g) {
            ...
            int y = (getHeight() - fontMetrics.getHeight() + 1) / 2 + fontMetrics.getAscent() + fontMetrics.getLeading();
